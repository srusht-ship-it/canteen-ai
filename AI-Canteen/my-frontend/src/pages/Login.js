          ...
          <Col xs={12} sm={10} md={8} lg={6} xl={5}>
            <Card className="login-card shadow-lg border-0">
              <Card.Body className="p-4 p-md-5">
                ...
                {/* Login Header */}
                <div className="text-center mb-4 mb-md-5">
                  <h2 className="fw-bold mb-2 mb-md-3">Login</h2>
                  <p className="text-muted mb-0">Welcome back. Sign in to continue.</p>
                </div>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <div className="text-end mb-4">
                    <Link to="/forgot-password" className="text-decoration-none text-muted forgot-link">
                      Forgot password?
                    </Link>
                  </div>
                  ...
                  <Button 
                    variant="success" 
                    type="submit" 
                    className="w-100 py-3 mb-4 fw-semibold sign-in-btn"
                    disabled={loading}
                  >
                    {loading ? (
                      <>
                  ...
                  <Row className="g-3 mb-4">
                    <Col xs={6}>
                      <Button 
                        ...
                        className="w-100 py-2 social-btn"
